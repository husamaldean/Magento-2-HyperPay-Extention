...
class Adapter extends \Magento\Framework\Model\AbstractModel
{
    ...
    const MERCHANT_ENTITY_ID = 'mentityId';
    ...
    {
        return $this->getConfigDataForSpecificMethod($code, self::CONNECTOR);
    }
    /**
    ...
    {
        return $this->getConfigDataForSpecificMethod($code, self::ENTITY_ID);

    }
    /**
     * Retrieve the merchant entity id from configuration
     *
     * @param  $code
     * @return string
     */
    ...
    {
        return $this->getConfigData(self::MERCHANT_ENTITY_ID);
    ...
    {
        return $this->getConfigDataForSpecificMethod($code, self::PAYMENT_ACTION);
    }
    /**
     ...
     * @return string
     */
    public function getSupportedCurrencyCode($code)
    {
        return $this->getConfigDataForSpecificMethod($code, self::CURRENCY_CODE);
    }
    /**
     ...
     * @return string
     */
    public function getApiUserName($code)
    {
        return $this->getConfigDataForSpecificMethod($code, self::API_USER_NAME);
    }
    /**
     ...
     * @return string
     */
    public function getApiSecret($code)
    {
        return $this->getConfigDataForSpecificMethod($code, self::API_SECRET);
    }
    /**
    ...
    {
        return $this->getConfigDataForSpecificMethod($code, self::MERCHANT_ID);
    }
    /**
     ...
     * @return string
     */
    public function getConfigDataForSpecificMethod($code,$field)
    {
        return $this->_scopeConfig->getValue('payment/'.$code.'/'.$field, $this->_storeScope);
